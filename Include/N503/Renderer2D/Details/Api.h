...
extern "C"
{
    ...
    N503_API N503Text N503CreateText(const char* content, const char* font, float size);

    N503_API int N503DestroyText(N503Text instance);

    N503_API int N503SetTextTransform(N503Text instance, const N503Transform2D transform);

    N503_API int N503SetTextColor(N503Text instance, const N503Color color);

    N503_API int N503SetTextVisible(N503Text instance, uint32_t visible);

    N503_API int N503SetTextContent(N503Text instance, const char* content);

    typedef struct N503TextLayout_t* N503TextLayout;

    typedef struct N503Typewriter_t* N503Typewriter;
